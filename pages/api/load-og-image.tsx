...
const decodeHtmlEntities = (str) =>
  str.replace(/&#x([0-9a-fA-F]+);/g, (_match, hex) =>
    String.fromCharCode(parseInt(hex, 16)),
  );

// TODO use proper (minimal) HTML parser, this doesn't handle all combinations (apostrophes, etc)
const regex1 = /<meta\s+property="og:image"\s+content="([^"]+)"/i;
const regex2 = /<meta\s+content="([^"]+)"\s+property="og:image"/i;
