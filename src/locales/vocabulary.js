...
export default {
  ...
  'climbing_badges.inclination_roof_description': 'Route has large overhangs or is completely horizontal (roof climbing).',
  'climbing_badges.inclination_roof_label': 'roof',
  'climbing_badges.inclination_slab_description': 'Low-angle climbing where friction and balance are key.',
  'climbing_badges.inclination_slab_label': 'slab',
  'climbing_badges.inclination_vertical_description': 'The route goes straight up or nearly vertical.',
