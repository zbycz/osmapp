...
export default {
  ...
  'featurepanel.uncertain_image': 'This is the closest street view image, it may show other objects.',
  ...
  'editdialog.comment_placeholder': 'Extra details, link to source, etc.',
  ...
  'editdialog.info_note': `Your suggestion will be reviewed by editors. You can add additional information for them below! If possible, please provide a link to the source that your suggestion is based on.`,
  'editdialog.other_tags': 'Edit Tags',
  'editdialog.other_tags.new_key': 'new key',
  'editdialog.other_tags.add': 'Add tag',
  ...
  'editsuccess.note.body': "This usually takes few days but could take longer if it's not a high traffic area.",
