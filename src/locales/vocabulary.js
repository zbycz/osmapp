...
export default {
  ...
  'climbing_badges.type_boulder_description': 'Short climbing problems close to the ground, usually without a rope.',
  'climbing_badges.type_boulder_label': 'boulder',
  'climbing_badges.type_deepwater_description': 'Unprotected climbing over deep water, relying on water to catch falls.',
  'climbing_badges.type_deepwater_label': 'deepwater',
  'climbing_badges.type_ice_description': 'Climbing on frozen water surfaces using ice tools and crampons.',
  'climbing_badges.type_ice_label': 'ice',
  'climbing_badges.type_label': 'Climbing type',
  'climbing_badges.type_mixed_description': 'Combination of rock and ice climbing, usually with tools.',
  'climbing_badges.type_mixed_label': 'mixed',
  'climbing_badges.type_multipitch_description': 'Route with multiple pitches, requiring intermediate belays.',
  'climbing_badges.type_multipitch_label': 'multipitch',
  'climbing_badges.type_speed_description': 'Competitive speed climbing route, usually on artificial walls.',
  'climbing_badges.type_speed_label': 'speed',
  'climbing_badges.type_sport_description': 'Climbing on bolted routes with fixed protection.',
  'climbing_badges.type_sport_label': 'sport',
  'climbing_badges.type_toprope_description': 'Climbing with a rope anchored above the climber.',
  'climbing_badges.type_toprope_label': 'top rope',
  'climbing_badges.type_trad_description': 'Traditional climbing using removable gear for protection.',
  'climbing_badges.type_trad_label': 'trad',
