...
export default {
  ...
  'homepage.indoorequal': 'for indoor maps',
  ...
  'editdialog.place_cancelled': 'Permanently closed',
  'editdialog.place_cancelled_deleted': 'The object will be deleted from the map.',
  'editdialog.place_cancelled_kept_tags': 'The object carries an address, so it will be kept – only these tags remain:',
  ...
  'climbingpanel.climbing_line_solid': 'Solid',
  'climbingpanel.climbing_line_dotted': 'Dotted',
  ...
  'climbing_badges.hazard_label': 'Hazards',
  ...
  'climbing_badges.hazard_dirty_rock_description': 'The rock surface is dusty, muddy, or otherwise dirty, which may reduce grip or safety.',
  'climbing_badges.hazard_dirty_rock_label': 'dirty rock',
  ...
  'climbing_badges.hazard_loose_rock_label': 'loose rock',
  'climbing_badges.hazard_missing_anchor_description': 'Anchor is missing; climber must improvise or bring gear.',
  'climbing_badges.hazard_missing_anchor_label': 'missing anchor',
  'climbing_badges.hazard_rockfall_zone_description': 'Area prone to falling rocks from above.',
  'climbing_badges.hazard_rockfall_zone_label': 'rockfall zone',
  'climbing_badges.hazard_unstable_anchor_description': 'A belay or rappel anchor is compromised or unsafe.',
  'climbing_badges.hazard_unstable_anchor_label': 'unstable anchor',
  'climbing_badges.hazard_vegetation_description': 'Obstructing plants, moss, or bushes along the route.',
  ...
  'climbing_badges.inclination_roof_description': 'A horizontal ceiling or near-horizontal section.',
  'climbing_badges.inclination_roof_label': 'roof',
  'climbing_badges.inclination_slab_description': 'A wall that leans back (<90°), requiring balance and technique.',
  'climbing_badges.inclination_slab_label': 'slab',
  'climbing_badges.inclination_traverse_description': 'A route with significant horizontal movement (sideways climbing).',
  'climbing_badges.inclination_traverse_label': 'traverse',
  'climbing_badges.inclination_vertical_description': 'A straight-up vertical wall (90° or nearly so).',
  'climbing_badges.inclination_vertical_label': 'vertical',

  'climbing_badges.type_label': 'Climbing type',
  'climbing_badges.boulder_description': 'Short climbing problems close to the ground, usually without a rope.',
  'climbing_badges.boulder_label': 'boulder',
  'climbing_badges.deepwater_description': 'Unprotected climbing over deep water, relying on water to catch falls.',
  'climbing_badges.deepwater_label': 'deepwater',
  'climbing_badges.ice_description': 'Climbing on frozen water surfaces using ice tools and crampons.',
  'climbing_badges.ice_label': 'ice',
  'climbing_badges.mixed_description': 'Combination of rock and ice climbing, usually with tools.',
  'climbing_badges.mixed_label': 'mixed',
  'climbing_badges.multipitch_description': 'Route with multiple pitches, requiring intermediate belays.',
  'climbing_badges.multipitch_label': 'multipitch',
  'climbing_badges.speed_description': 'Competitive speed climbing route, usually on artificial walls.',
  'climbing_badges.speed_label': 'speed',
  'climbing_badges.sport_description': 'Climbing on bolted routes with fixed protection.',
  'climbing_badges.sport_label': 'sport',
  'climbing_badges.toprope_description': 'Climbing with a rope anchored above the climber.',
  ...
  'climbing_rock.label': 'Rock material',
  'climbing_rock.limestone': 'limestone',
  ...
  'climbing_rock.slate': 'slate',
  'climbing_rock.dolomite': 'dolomite',
  'climbing_rock.concrete': 'concrete',
  'climbing_rock.puddingstone': 'puddingstone',
  'climbing_rock.phyllite': 'phyllite',
  'climbing_rock.artificial': 'artificial rock',
  'climbing_rock.ignimbrite': 'ignimbrite',
  'climbing_rock.schist': 'schist',
