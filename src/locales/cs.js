export default {
  ...
  'climbing_badges.type_boulder_description': 'Krátké bouldrové problémy blízko země, obvykle bez lana.',
  'climbing_badges.type_boulder_label': 'boulder',
  'climbing_badges.type_deepwater_description': 'Lezení bez jištění nad hlubokou vodou – pád tlumí hladina.',
  'climbing_badges.type_deepwater_label': 'deep water solo',
  'climbing_badges.type_ice_description': 'Lezení po ledu s cepíny a mačkami.',
  'climbing_badges.type_ice_label': 'ledová',
  'climbing_badges.type_label': 'Typ lezení',
  'climbing_badges.type_mixed_description': 'Smíšené lezení po skále i ledu, často s náčiním.',
  'climbing_badges.type_mixed_label': 'mix',
  'climbing_badges.type_multipitch_description': 'Vícedélková cesta vyžadující vícero stanovišť.',
  'climbing_badges.type_multipitch_label': 'vícedélka',
  'climbing_badges.type_speed_description': 'Rychlostní závodní cesta, většinou na umělé stěně.',
  'climbing_badges.type_speed_label': 'rychlostní',
  'climbing_badges.type_sport_description': 'Sportovní cesta s fixním jištěním (borháky, nýty).',
  'climbing_badges.type_sport_label': 'sportovní',
  'climbing_badges.type_toprope_description': 'Lezení s horním jištěním – lano ukotveno nahoře.',
  'climbing_badges.type_toprope_label': 'top rope',
  'climbing_badges.type_trad_description': 'Tradiční lezení s využitím vlastního postupového jištění.',
  'climbing_badges.type_trad_label': 'tradiční lezení',
