export default {
  ...
  'install.ios_share': 'Klikněte na <strong>ikonku Sdílet</strong>',
  'install.ios_add': 'Klikněte na <strong>Přidat na domovskou obrazovku</strong>',
  'install.android_intro': 'Otevřete osmapp.org v <strong>prohlížeči Chrome či Firefox</strong>',
  'install.android_share': 'Klikněte na <strong>trojtečkové menu</strong>',
  'install.android_add': 'Klikněte na <strong>Instalovat aplikaci</strong>',
  'install.desktop_intro': 'Otevřete osmapp.org v prohlížečích <strong>Chrome</strong>, <strong>Firefox</strong> nebo <strong>Opera</strong>',
