...
export const outdoorStyle = addHoverPaint({
  ...
  layers: [
    ...
    },
    {
      ...
      type: 'fill',
      paint: { 'fill-color': 'rgba(224, 230, 202, 1)', 'fill-opacity': 1 },
    ...
    },
    {
      ...
      type: 'fill',
      paint: { 'fill-color': 'rgba(216, 236, 208, 1)', 'fill-opacity': 1 },
    ...
    },
    {
      ...
      type: 'fill',
      paint: { 'fill-color': 'rgba(200, 232, 176, 1)', 'fill-opacity': 1 },
    ...
    },
    {
      ...
      type: 'fill',
      paint: { 'fill-color': 'rgba(255, 255, 255, 0.9)', 'fill-opacity': 1 },
    ...
    },
    {
      id: 'landuse_cemetery',
      type: 'fill',
      paint: { 'fill-color': 'rgba(161, 216, 103, 1)', 'fill-opacity': 0.5 },
    ...
    },
    {
      id: 'landuse_hospital',
      type: 'fill',
      paint: { 'fill-color': 'rgba(244, 222, 236, 1)', 'fill-opacity': 0.5 },
    ...
    },
    {
      ...
      paint: {
        'fill-color': {
          stops: [
            [6, 'rgba(141, 214, 141, 0)'],
            [14, 'rgba(157, 236, 156, 0.91)'],
          ],
        },
        'fill-opacity': {
          stops: [
    ...
    },
    {
      ...
      type: 'line',
      paint: {
        'line-color': 'rgba(119, 165, 203, 0.62)',
        'line-width': {
          base: 1.3,
          stops: [
            [13, 1],
    ...
    },
    {
      ...
      type: 'fill',
      paint: { 'fill-color': 'rgba(191, 216, 249, 1)', 'fill-opacity': 1 },
      filter: ['all', ['==', 'intermittent', 1]],
      layout: { visibility: 'visible' },
      source: 'maptiler_planet',
      metadata: {},
    ...
    },
    {
      id: 'aeroway_fill',
      type: 'fill',
      paint: { 'fill-color': 'rgba(228, 228, 228, 1)', 'fill-opacity': 1 },
      filter: ['==', '$type', 'Polygon'],
      source: 'maptiler_planet',
      minzoom: 11,
      metadata: {},
    ...
    },
    {
      id: 'road_area_pier',
      type: 'fill',
      paint: { 'fill-color': 'rgba(242, 243, 242, 1)', 'fill-antialias': true },
    ...
    },
    {
      ...
      filter: [
        'all',
        ['in', 'symbol', ':brown::Klangweg:white', 'white::brown_hiker'],
      ],
      layout: {
        'line-cap': 'round',
        'line-join': 'miter',
    ...
    },
    {
      id: 'trail_red_casing',
      type: 'line',
      paint: { 'line-color': 'rgba(253, 252, 252, 1)', 'line-width': 4 },
      filter: ['all', ['==', 'color', 'red']],
      layout: {
        'line-cap': 'round',
        'line-join': 'miter',
        visibility: 'visible',
    ...
    },
    {
      ...
      filter: ['all', ['==', 'class', 'via_ferrata']],
      layout: {
        'text-font': ['Open Sans Bold', 'Roboto Regular'],
        'text-size': 16,
        'text-field': '.',
        visibility: 'visible',
        'icon-anchor': 'bottom',
    ...
    },
    {
      ...
      layout: { 'icon-size': 1, 'icon-image': 'spring', visibility: 'visible' },
      source: 'outdoor',
      minzoom: 16,
      'source-layer': 'outdoor_poi',
    },
    ...
    },
    {
      ...
      layout: { 'icon-size': 1, 'icon-image': 'picnic', visibility: 'visible' },
      source: 'outdoor',
      minzoom: 14,
      'source-layer': 'outdoor_poi',
    },
    ...
    },
    {
      ...
      layout: {
        ...
        'icon-image': 'peak',
        'text-field': '{name} {name:nonlatin} {ele} m',
        visibility: 'visible',
        'icon-anchor': 'center',
        'text-anchor': 'top',
        'text-offset': [0, 0.5],
    ...
    },
    {
      ...
      layout: {
        'text-font': ['Roboto Italic', 'Noto Sans Regular'],
        'text-size': {
          stops: [
            [10, 12],
            [14, 16],
    ...
    },
    {
      ...
      layout: {
        'text-font': ['Roboto Condensed Italic', 'Noto Sans Regular'],
        'text-size': {
          base: 1.2,
          stops: [
            [11, 11],
