...
export const routes1: ClimbingRoute[] = [
  {
    ...
    path: [
      ...
      { x: 0.37987640581068416, y: 0.4825, units: 'percentage', type: 'bolt' },
  ...
  },
  {
    ...
    path: [
      ...
      { x: 0.46141342549203374, y: 0.7425, units: 'percentage', type: 'bolt' },
      ...
      { x: 0.5513853092783505, y: 0.18, units: 'percentage', type: 'belay' },
    ],
  },
  {
  ...
  },
  {
    ...
    path: [
      ...
      { x: 0.5720038659793815, y: 0.32875, units: 'percentage', type: 'bolt' },
      { x: 0.540138823805061, y: 0.23375, units: 'percentage' },
      { x: 0.5513853092783505, y: 0.18, units: 'percentage', type: 'belay' },
    ],
  },
