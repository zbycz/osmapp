...
apiMocks.commonsCategory = {
  url: 'https://commons.wikimedia.org/w/api.php?action=query&prop=imageinfo&iiprop=url&iiurlwidth=640&format=json&titles=Category%3AYosemite%20National%20Park&origin=*',
  response: {
    batchcomplete: '',
    query: {
      pages: {
...
apiMocks.commonsFile = {
  url: 'https://commons.wikimedia.org/w/api.php?action=query&prop=imageinfo&iiprop=url&iiurlwidth=640&format=json&titles=File%3AHlubo%C4%8Depsk%C3%A9%20plotny%20-%20Prav%C3%A1%20plotna.jpg&origin=*',
  response: {
    batchcomplete: '',
    query: {
      pages: {
          ...
          imageinfo: [
            {
              ...
              thumbheight: 490,
              responsiveUrls: {
                '2': 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Hlubo%C4%8Depsk%C3%A9_plotny_-_Prav%C3%A1_plotna.jpg/1280px-Hlubo%C4%8Depsk%C3%A9_plotny_-_Prav%C3%A1_plotna.jpg',
                '1.5':
                  'https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Hlubo%C4%8Depsk%C3%A9_plotny_-_Prav%C3%A1_plotna.jpg/960px-Hlubo%C4%8Depsk%C3%A9_plotny_-_Prav%C3%A1_plotna.jpg',
              },
...
apiMocks.wikipedia = {
  url: 'https://en.wikipedia.org/w/api.php?action=query&prop=pageimages&pithumbsize=640&format=json&titles=Yosemite%20National%20Park&origin=*',
  response: {
    batchcomplete: '',
    query: {
      pages: {
...
apiMocks.wikipediaCs = {
  url: 'https://cs.wikipedia.org/w/api.php?action=query&prop=pageimages&pithumbsize=640&format=json&titles=Yosemite%20National%20Park&origin=*',
